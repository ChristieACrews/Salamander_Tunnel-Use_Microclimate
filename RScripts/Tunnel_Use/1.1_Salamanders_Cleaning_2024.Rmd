...
7)	TrapID: The ID of the trap a salamander was captured in, if applicable (categorical). Traps are identified by a 3 character code designating tunnel number (1-4, starting at the northernmost tunnel), side of road (East or West), and trap number (1 or 2)
...
17)	HabitatType: The habitat type at a capture location or a control location
...
22)	Sex_Stage: The sex and life stage of a captured individual
