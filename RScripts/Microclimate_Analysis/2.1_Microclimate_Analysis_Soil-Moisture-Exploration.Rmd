---
title: "2.1 Microclimate Data Analysis - Soil Moisture Data Exploration"
...
This is the second part of my pipeline, but the first script for data analysis. The input for this script is the output from the script "1.3 Microclimate Data Cleaning - Filter to Soil Moisture"
...
```{r}
data %>% ggplot(aes(x = Soil_Moisture_VWC, y = CoverID, colour = CoverID)) +
  geom_point() +
...
Some values have a known explanation. 1W1, for example, is known to flood and have high ground water levels at times, thus a higher reading could be expected after extreme rain. I double checked data entry to see if outlier values are typing errors, but this was not the case. Many of the larger outliers were also on the same day.
